...
class CustomizationPage:
      ...
      COLOR_FULLSCREEN_BUTTON = 'teal-600'
      COLOR_EXIT_FULLSCREEN_BUTTON = 'teal-500'
                  ...
                  with ui.grid(columns=2):
                        ...
                        with ui.card():
                              ...
                              with ui.row():
                                    ...
                                    ui.space()
                                    self.fullscreenButton = ui.button(icon='fullscreen', color=self.COLOR_FULLSCREEN_BUTTON, on_click=fullscreen.toggle).props('outline color='+self.COLOR_FULLSCREEN_BUTTON)
                        with ui.card():
